...
def main_dashboard():
    ...
    with col2:
        ...
        if run_btn:
            ...
            # 1. แสดงผลวิเคราะห์การแต่งกาย (อิงตามภาพวิเคราะห์จริง)
            ...
            # --- 3. ส่วนที่ปรับปรุง: รายละเอียดสิ่งที่ควรเตรียมเพิ่มเติม ---
            ...
            # ปรับปรุง Expander และเนื้อหาด้านใน (ตัดข้อมูลอื่นออกทั้งหมดตามสั่ง)
            with st.expander("คลิกเพื่อดูรายละเอียดสิ่งที่เตรียม"):
                st.markdown(f"""
                **เจาะจงรายละเอียดและประโยชน์เพื่อประกอบการตัดสินใจ:**
                
                1. **เสื้อโค้ทกันหนาวหนาพิเศษ**: ประโยชน์หลักคือการกักเก็บอุณหภูมิร่างกายและกันลมจากภายนอก จำเป็นอย่างยิ่งสำหรับอากาศ 1.8°C เพื่อป้องกันภาวะตัวเย็นเกิน
                2. **กางเกงบุขนกันหนาว**: ช่วยสร้างชั้นฉนวนกันความร้อนบริเวณเรียวขา ป้องกันความเย็นกัดผิวเมื่อต้องเดินกลางแจ้งเป็นเวลานาน
                3. **หมวกไหมพรมและผ้าพันคอ**: ปิดจุดอ่อนที่ร่างกายสูญเสียความร้อนได้ง่าย (ศีรษะและลำคอ) ช่วยลดโอกาสการเป็นหวัดและอาการคัดจมูก
                4. **รองเท้าบูทกันหนาว**: ช่วยป้องกันความเย็นจัดจากพื้นถนนและหิมะไม่ให้ส่งผ่านถึงฝ่าเท้า พร้อมให้การยึดเกาะที่ดีกว่ารองเท้าผ้าใบปกติ
                5. **แผ่นแปะความร้อนและถุงมือ**: เป็นตัวช่วยเร่งด่วนในการเพิ่มความร้อนเฉพาะจุด (มือ/ลำตัว) ช่วยให้ร่างกายอุ่นเร็วขึ้นในจังหวะที่ต้องเผชิญลมหนาวจัด
                """)

            # --- 4. ส่วนแหล่งช้อปปิ้งแนะนำ ---
