...
def main_dashboard():
    ...
    with col1:
        with st.container(border=True):
            ...
            gender = st.radio("เพศ", ["ชาย", "หญิง"]) # แก้ไขการย่อหน้า
    ...
    with col2:
        if run_btn:
            ...
            # --- ส่วนแสดงข้อมูลสภาพอากาศ (Weather Info) ---
            ...
            # --- ส่วนผลการวิเคราะห์ (AI Critique) ---
            ...
            # --- รายละเอียดประโยชน์ประกอบการตัดสินใจ ---
            with st.expander("💡 คลิกเพื่อดูรายละเอียดและประโยชน์ของแต่ละไอเทม"):
                st.markdown(f"""
                1. **เสื้อโค้ทกันหนาว**: ช่วยกักเก็บความร้อนในร่างกายและเป็นเกราะกันลมหนาว 1.8°C ได้อย่างมีประสิทธิภาพ
                2. **กางเกงบุขน**: ชั้นขนด้านในทำหน้าที่เป็นฉนวนกันความเย็น ป้องกันผิวอักเสบจากความเย็นจัด
                3. **หมวกและผ้าพันคอ**: ช่วยรักษาอุณหภูมิบริเวณศีรษะและลำคอ ซึ่งเป็นจุดที่ความร้อนออกจากร่างกายได้ง่าย
                4. **รองเท้าบูท**: ป้องกันความเย็นจากพื้นดินและกันความชื้นกรณีมีละอองฝนหรือหิมะละลาย
                5. **แผ่นแปะความร้อน**: ช่วยเพิ่มความร้อนอย่างรวดเร็วในจุดที่เลือดหมุนเวียนไปถึงได้ยาก เช่น ปลายนิ้ว
                """)
