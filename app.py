...
def main_dashboard():
    ...
    with col1:
        with st.container(border=True):
            ...
            # ย่อหน้าให้ตรงกับบรรทัดด้านบน (ภายใต้ with col1)
    ...
    with col2:
        if run_btn:
            ...
            # --- ส่วนที่เพิ่มใหม่: แสดงข้อมูลสภาพอากาศและคำเตือน ---
...
with w_col2:
    # คำเตือนสภาพอากาศ (ปรับตามประเทศที่เลือกได้)
    warning_text = "⚠️ ระวังพื้นถนนลื่นและลมหนาวจัด" if country in ["ญี่ปุ่น", "เกาหลีใต้"] else "⚠️ ระวังฝนละอองและความชื้นสูง"
...
st.divider() # เส้นคั่นเพื่อความสวยงาม
            ...
            with st.expander("คลิกเพื่อดูรายละเอียดสิ่งที่เตรียม"):
                ...
                **รายละเอียดและประโยชน์ประกอบการตัดสินใจ (อากาศหนาวจัด):**
                ...
                1. **เสื้อโค้ทกันหนาวหนาพิเศษ**: ช่วยกักเก็บความร้อนในร่างกายและเป็นเกราะกันลมหนาว 1.8°C ได้อย่างมีประสิทธิภาพ
                2. **กางเกงบุขนกันหนาว**: ชั้นขนด้านในทำหน้าที่เป็นฉนวนกันความเย็น ป้องกันผิวอักเสบจากความเย็นจัด
                3. **หมวกไหมพรมและผ้าพันคอ**: ปิดช่องว่างที่ลมหนาวจะเข้าสู่ร่างกาย ช่วยรักษาอุณหภูมิบริเวณศีรษะให้คงที่
                4. **รองเท้าบูทกันหนาว**: ป้องกันความเย็นจากพื้นดินและกันความชื้นกรณีมีหิมะหรือละอองฝน
                5. **แผ่นแปะความร้อนและถุงมือ**: ช่วยเพิ่มความร้อนอย่างรวดเร็วในจุดที่ปลายนิ้วซึ่งเลือดหมุนเวียนไปถึงได้ยาก
                """)
