...
def main_dashboard():
    ...
    with col2:
        if run_btn:
            ...
            st.markdown("### 🛍️ แหล่งช้อปปิ้งแนะนำ (5 อย่างหลัก)")
            items = ["เสื้อโค้ทกันหนาว", "ชุดลองจอน", "หมวกไหมพรม", "รองเท้าบูท", "แผ่นแปะความร้อน"]
            for it in items:
            ...
            st.info("👈 กรุณาใส่ข้อมูลและอัปโหลดรูปเพื่อเริ่ม")

# --- 🔐 3. ระบบจัดการหน้าจอ (ป้องกันหน้าขาว) ---
def login_page():
